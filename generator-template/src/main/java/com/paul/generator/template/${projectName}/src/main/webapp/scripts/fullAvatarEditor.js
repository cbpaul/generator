function fullAvatarEditor() {
	...
	var file			= 'media/uploadPhoto/fullAvatarEditor.swf';		//flash鏂囦欢鐨勮矾寰�
	var	version			= "10.1.0";						//鎾斁璇lash鎵�渶鐨勬渶浣庣増鏈�
	var	expressInstall	= 'media/uploadPhoto/expressInstall.swf';			//expressInstall.swf鐨勮矾寰�
	...
	//鏅鸿兘鑾峰彇鍙傛暟锛屽瓧绗︾被鍨嬩负瑁呰浇flash鏂囦欢鐨勫鍣�濡俤iv)鐨刬d锛岀涓�釜鏁板瓧绫诲瀷鐨勪负楂樺害锛岀浜屼釜涓哄搴︼紝绗竴涓猳bject绫诲瀷鐨勪负鍙傛暟瀵硅薄锛屽姝�涓弬鏁扮殑椤哄簭鍙殢鎰忋�
